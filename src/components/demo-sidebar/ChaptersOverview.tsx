                ...
                <Container className={"pb-0 flex-column pe-0"}>
                    <Row className={"chapters-navigation"}>
                        <Collapse in={navigationOpen}>
                            <Col className={"ps-4"}>
                                <ul className={"chapters-list m-0 p-0"}
                                    tabIndex={-1}
                                    onKeyDown={(e) => {
                                        switch (e.key) {
                                            case "Enter":
                                            { console.log('focusing on active chapter');
                                                ...
                                                let activeChapterButton = currentContainer?.children.item(activeChapter)?.firstElementChild as HTMLElement;
                                                console.log('active chapter button', activeChapterButton);
